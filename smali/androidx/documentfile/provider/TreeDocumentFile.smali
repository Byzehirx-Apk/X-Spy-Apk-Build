...
.method constructor <init>(Landroidx/documentfile/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .local v0, "this":Landroidx/documentfile/provider/TreeDocumentFile;
    move-object v1, p1
...
.method private static createFile(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .local v1, "self":Landroid/net/Uri;
    move-object v2, p2
...
.method public canRead()Z
    ...
    .end local v0    # "this":Landroidx/documentfile/provider/TreeDocumentFile;
    return v0
.end method
...
.method public createDirectory(Ljava/lang/String;)Landroidx/documentfile/provider/DocumentFile;
    ...
    .restart local v0    # "this":Landroidx/documentfile/provider/TreeDocumentFile;
    :cond_0
    const/4 v3, 0x0
...
.method public listFiles()[Landroidx/documentfile/provider/DocumentFile;
    ...
    .line 141
    .local v3, "results":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/net/Uri;>;"
    const/4 v8, 0x0
    ...
    const-string/jumbo v13, "document_id"
    ...
    .line 149
    .local v6, "documentUri":Landroid/net/Uri;
    move-object v8, v3
    ...
    .end local v6    # "documentUri":Landroid/net/Uri;
    :cond_0
    move-object v8, v4
    ...
    .line 159
    .local v6, "resultFiles":[Landroidx/documentfile/provider/DocumentFile;
    const/4 v8, 0x0
    ...
    .end local v6    # "resultFiles":[Landroidx/documentfile/provider/DocumentFile;
    .end local v7    # "i":I
    :catch_0
    move-exception v8
    ...
    :try_start_1
    const-string/jumbo v8, "DocumentFile"
    ...
    const-string/jumbo v10, "Failed query: "
    ...
    .line 162
    .local v5, "result":[Landroid/net/Uri;
    .restart local v6    # "resultFiles":[Landroidx/documentfile/provider/DocumentFile;
